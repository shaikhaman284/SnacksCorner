    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .login-options .btn.btn-secondary {
                background: transparent;
                color: #666;
            }
            ...
            .login-options .btn.btn-secondary:hover {
    ...
    <body>
        ...
        <section class="registration-section">
            <div class="registration-content">
                ...
                <div class="login-options">
                    <button class="btn btn-primary" id="userBtn" onclick="showUserLogin()">👤 User Login</button>
                    <button class="btn btn-secondary" id="adminBtn" onclick="showAdminLogin()">🔐 Admin Login</button>
                </div>

                <div id="userLoginForm" class="login-form" style="display: block;">
                    <h3>🍿 User Login</h3>
                    <form action="userLogin" method="post" class="registration-form">
                        <div class="form-group">
                            <label for="userLoginId">🆔 Login ID:</label>
                            <input type="text" name="loginId" id="userLoginId" required 
                        ...
                        <button type="submit" class="cta">🚀 Login to Account</button>
                    </form>
                    <p id="registerLink">Don't have an account? <a href="<c:url value='/register'/>">Create one here!</a></p>
                </div>
        ...
        <script>
            ...
            function showUserLogin() {
                ...
                document.getElementById("adminBtn").className = "btn btn-secondary";
            }
            ...
            function showAdminLogin() {
                ...
                // Update button styles
                document.getElementById("adminBtn").className = "btn btn-primary";
            ...
            document.addEventListener('keydown', function (e) {
                ...
                // Quick switch between login types
                if (e.altKey && e.key === '1') {
                    showUserLogin();
                }
                if (e.altKey && e.key === '2') {
